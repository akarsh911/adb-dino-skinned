...
function handleRun(delta, speedScale) {
  if (isJumping) {
    dino.src = `assets/q-run_0.png`;
    return;
  }

  if (currentFrameTime >= FRAME_TIME) {
    dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
    dino.src = `assets/q-run_${dinoFrame}.png`; /* switch between images to simulate movement */
...
const CACTUS_INTERVAL_MAX = 3500;
